...
type DenialNextSteps struct {
	...
	// ProposePolicy is where to POST a new draft policy when the
	// agent believes the rule should be relaxed (or is missing).
	ProposePolicy string `json:"propose_policy"`
